...
In many of these cases, the data may corroborate the researcher's claim, but the interpretation of a null hypothesis significance test (NHST), wherein the null hypothesis is "no effect", is nonetheless incorrect. 
In order to statistically test for whether there is "no effect" or "no difference" researchers could use equivalence testing. 
