---
title: |
  Exploring Equivalence Testing with the TOSTER R package
author:
...
In `TOSTER` we go a tad farther and calculate a more generalizable non-centrality parameter that allows the equivalence test for *F*-tests to be applied to variety of designs.
