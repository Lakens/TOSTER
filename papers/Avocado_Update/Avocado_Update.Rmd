...
```{r fig.width=6, fig.height=6,fig.cap="Example of consonance density plot."}
plot(res1, type = "cd")
```
...
```{r fig.width=6, fig.height=6, fig.cap = "Demonstrating the shading in plot method."}
plot(res1, type = "cd",
     ci_shades = c(.9,.95))
```
...
```{r fig.width=6, fig.height=6, fig.cap = "Example of consonance plot."}
plot(res1, type = "c",
     ci_lines =  c(.9,.95))
```
