...
powerTOSTraw<-function(alpha, statistical_power, low_eqbound, high_eqbound, sdpooled, epsilon){
  ...
  NT1<-2*sdpooled^2*(qnorm(1-alpha)+qnorm(1-((1-statistical_power)/2)))^2/(0-low_eqbound-epsilon)^2
  NT2<-2*sdpooled^2*(qnorm(1-alpha)+qnorm(1-((1-statistical_power)/2)))^2/(high_eqbound-0-epsilon)^2
