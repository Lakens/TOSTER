...
powerTOST<-function(alpha, statistical_power, low_eqbound_d, high_eqbound_d, epsilon){
  ...
  NT1<-2*(qnorm(1-alpha)+qnorm(1-((1-statistical_power)/2)))^2/(0-low_eqbound_d-epsilon)^2
  NT2<-2*(qnorm(1-alpha)+qnorm(1-((1-statistical_power)/2)))^2/(high_eqbound_d-0-epsilon)^2
