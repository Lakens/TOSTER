...
test_that("Run examples for one sample", {
  ...
  test4 =suppressWarnings({ t_TOST(x = samp1,
                 low_eqbound = -.5,
                 high_eqbound = .5,
                 eqbound_type = "SMD",
                 hypothesis = "MET")})
  ...
  tsum2 = suppressWarnings({ tsum_TOST(m1 = mean(samp1),
                    sd1 = sd(samp1),
                    n1 = length(samp1),
                    low_eqbound = -.5,
                    high_eqbound = .5,
  ...
  tsum4 = suppressWarnings({tsum_TOST(m1 = mean(samp1),
                    sd1 = sd(samp1),
                    n1 = length(samp1),
                    low_eqbound = -.5,
                    high_eqbound = .5,
  ...
  test2 = suppressWarnings({  t_TOST(x = samp1,
                 low_eqbound = -.5,
                 high_eqbound = .5,
                 eqbound_type = "SMD",
                 bias_correction = FALSE)
