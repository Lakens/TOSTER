...
Setting `paired = TRUE` changes the analysis to account for within-subject correlations. Note that for paired tests, we use separate vectors (x and y) rather than the formula notation, as formula notation represents independent groups.
