...
For all SMD calculative approaches the bias corrected SMD was calculated as the following:

$$
g = d \cdot \frac{\Gamma(\frac{df}{2})}{\sqrt{\frac{df}{2}} \cdot \Gamma(\frac{df-1}{2})} 
$$
...
$$
The SMD, Cohen's d, is then calculated as the following:

$$
d = \frac {\bar{x}_1 - \bar{x}_2} {s_{p}}
$$
Note: the x with the bar above it (pronouced "x-bar") refers the the means of group 1 and 2 respectively.
