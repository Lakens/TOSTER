...
**Warning: many of these functions are deprecated.**

Please see the "Introduction to t_TOST" vignette for details on the up-to-date functions. This vignette, and the functions used, will continue to be in the package for continuity purposes.
