...
Paired t-test in equivalence package (from example in tost function) and TOSTpaired.raw. Note the code below does not run by default (to not require installing the package) but the output is provided:
...
We can reproduce this result using TOSTER using the TOSTpaired.raw function:
...
Using alpha = 0.05 the NHST t-test was significant, t(376) = 2.42201, p = 0.01590709
Using alpha = 0.05 the equivalence test was significant, t(376) = -16.99448, p = 9.130218e-49TOST results:
  t-value 1    p-value 1 t-value 2    p-value 2  df
1   21.8385 3.655235e-69 -16.99448 9.130218e-49 376
