...
|--------|---------------|-------------|---------------|
| **Wilcoxon-Mann-Whitney tests** | Simple, widely accepted | Ambiguous hypothesis; not about means or medians | legacy analyses |
| **Brunner-Munzel test** | Clear interpretation, robust to heteroscedasticity | Computationally intensive with permutation | Stochastic superiority/dominance |
