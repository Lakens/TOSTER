...
In many bioequivalence studies, the differences between drugs are compared on the log scale.
...
$$
In addition, the United States Food and Drug Administration (FDA), considers 
