...
In this package we have opted to make the default SMD confidence intervals as the formulation
...
$$
\sigma_{SMD} =     \sqrt{\frac{n-1}{n \cdot (n-3)} \cdot (2\cdot(1-r_{12})+d^2 \cdot N) + \frac{d^2}{J^2}}
