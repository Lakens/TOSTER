...
reported as Cohen's d. The simplest form involves reporting the mean
...
In this package we have opted to the (mostly) use the approaches
...
This calculation was derived from the supplementary material of
@Cousineau2021.
...
In some cases, SMDs between original and replication studies want to be compared. Rather than looking at whether or not a replication attempt is significant, a researcher could compare to see how compatible the SMDs are between the two studies.
...
We can see from the results below that, if the null hypothesis were true, we would only expect to see a disprency in SMDs between studies at least this large ~1% of the time.
