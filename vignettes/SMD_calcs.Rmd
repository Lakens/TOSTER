...
recommend using bootstrapping techniques rather than any of these approximations whenever possible [@Kirby2013], and these methods are available in the `boot_smd_calc` function.
