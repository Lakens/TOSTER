...
2. Under all other methods^[Originally, I used an estimate of the standard error from Morris and DeShon. However, it was pointed out by colleague that this wasn't very accurate. We now use what is reported by @delacre2021 wherein $\sigma_e$ is the variance of the group *not* used as the denominator for Glass's delta] (nct, t, or z) derived from derived from @delacre2021:
