...
$$
H_0: \space \eta^2_p \leq \Delta \quad \text{(Effect is not meaningfully large)}
\\
H_1: \space \eta^2_p > \Delta \quad \text{(Effect is meaningfully large)}
$$
