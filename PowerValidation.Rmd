...
powerTOSTone.raw(alpha=0.05, statistical_power=0.8, sd = 0.1, low_eqbound=-0.05, high_eqbound=0.05, epsilon=0) #35
...
```{r}
require(TOSTER)
powerTOSTpaired(alpha=0.05, statistical_power=0.8, low_eqbound_dz=-0.1, high_eqbound_dz=0.1, epsilon=0) #Calculate n pairs
